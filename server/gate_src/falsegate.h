...
/**
 * @brief False gate class.
 *
 * The False gate class represents a boolean false value.
...
public:
    /**
     * @brief False gate constructor.
     *
     * Instantiates a new false gate object.
     *
     * @param parent Initializes the false gate with a qobject parent if desired
     * or can be instantiated without if desired.
     */
    explicit falseGate(QObject *parent = 0);

    /**
     * @brief Init function.
     *
     * Initializes the False gate to gateName.
     * Sets the LogicLevel to logicFalse.
     *
     ...
     *
     * This will always return 0 for falseGate.
     *
